...
This is a Minecraft Java server using Fabric with mods running in a [Docker container](docker-compose.yml) and exposing the server to the internet using Tailscale.
...
- [Docker Container](https://docker-minecraft-server.readthedocs.io/en/latest/)
